...
| [`context-tax-reminder`](context-tax-reminder/) | *You Just Installed 10 Skills. I Wrote One Rule.* | Hook — watches how heavy your session has gotten and tells the agent to recommend `/clear` when your prompt opens a new topic. |
| [`blind-test-protocol`](blind-test-protocol/) | *You Just Installed 10 Skills. I Wrote One Rule.* | Scripts — run a hyped tool through a blind test on your own material before you adopt it: randomized ground truth, exact diff, no vibes. |
